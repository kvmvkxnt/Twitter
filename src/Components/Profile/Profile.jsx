            ...
            <div className="profile__inner">
                ...
                <div className="profile__info" style={!imgSrc ? { marginTop: "90px" } : null}>
                    ...
                    <div className="profile__info__overview">
                        ...
                        <a href={username === '@bobur_mavlonov' ? 'https://t.me/bobur_mavlonov' : `mailto:${username}`} className="profile__info__item profile__info__link">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.6">
                            ...
                            {username === '@bobur_mavlonov' ? 't.me/bobur_mavlonov' : username}
                        </a>
